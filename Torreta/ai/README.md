...
Basado en el proyecto [PyTorch YOLOv3](https://github.com/eriklindernoren/PyTorch-YOLOv3) para correr detección de objetos sobre video. Se ha añadido capacidad de detectar objetos en un stream de video en vivo.
